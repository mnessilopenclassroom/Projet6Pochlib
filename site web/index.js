    ...
    .then((results) => {
      ...
      if (results.data.totalItems === 0) {
        ...
        for (let i = 0; i < results.data.items.length; i++) {
          ...
          description = (results.data.items[i].volumeInfo.description === undefined) ? description = "Information manquante" : description = (results.data.items[i].volumeInfo.description.length > 200) ?
